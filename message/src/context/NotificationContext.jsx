    ...
    useEffect(() => {
        ...
        try {
            ...
            newSocket.on('connection_request', (data) => {
                // In a real app, you might want to show a specific toast or update a connections list context
                // For now, we rely on the simultaneous 'new_notification' event for the bell
                console.log("New connection request:", data);
            });

            // Listen for connection status updates (accepted/rejected)
